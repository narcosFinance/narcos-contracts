...
contract Pancake is Ownable {
    ...
    IBEP20 public token = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    function _convertTokenToBUSD() internal {
        ...
        if(_amount > 0){
            ...
            router.swapExactTokensForTokensSupportingFeeOnTransferTokens(_amount, uint256(0), ISChef(address(chef)).getPathTokenStrategySell(address(token)), address(this), now.add(1800));
            if(balanceBUSD() > 0){
