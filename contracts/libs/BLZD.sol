...
contract BLZD is Ownable {
    ...
    IBEP20 public token = IBEP20(0x57067A6BD75c0E95a6A5f158455926e43E79BeB0);
    ...
    function pending() external view returns (uint256) {
        return pool.pendingBlzd(pid, address(this));
    }       
